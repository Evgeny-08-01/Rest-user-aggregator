        ...
        "/subscriptions": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "integer",
                        "description": "Лимит фильтрации (должен быть \u003e 0)",
                        "name": "limit",
                        "in": "query"
                    },
                    {
                        "type": "integer",
                        "description": "Офсет фильтрации (должен быть \u003e= 0)",
                        "name": "offset",
                        "in": "query"
                    }
                ],
        ...
        "/subscriptions/total-cost": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Дата окончания (MM-YYYY) или пустое значение = без верхней границы",
                        "name": "end_date",
                        "in": "query"
                    }
                ],
                "responses": {
                    "200": {
                        "description": "суммарная стоимость всех подписок",
                        "schema": {
                            "type": "object",
                            "additionalProperties": {
                                "type": "integer"
