// Package repository - MockSubRepo — фейковый репозиторий для тестов
package repository
...
func (m *MockSubRepo) ListSubscriptions(ctx context.Context, limit, offset int) ([]models.Subscription, error) {
	if m.ListSubMock != nil {
		return m.ListSubMock(ctx, limit, offset)
	}
